...
namespace OnlineAuction.API.Migrations
{
    ...
    [Migration("20210616145400_TheNewMigration4")]
    partial class TheNewMigration4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineAuction.API.Auth.Role", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("OnlineAuction.API.Auth.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("OnlineAuction.API.Models.Lot", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("OnlineAuction.API.Models.LotCathegory", b =>
                {
                    b.Property<long>("LotId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("LotId", "CathegoryId");

                    b.HasIndex("CathegoryId");

                    b.ToTable("LotCathegories");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<long>", b =>
                {
                    b.HasOne("OnlineAuction.API.Auth.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("OnlineAuction.API.Auth.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineAuction.API.Models.Bet", b =>
                {
                    b.HasOne("OnlineAuction.API.Models.Lot", null)
                        .WithMany("Bets")
                        .HasForeignKey("LotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OnlineAuction.API.Models.LotCathegory", b =>
                {
                    b.HasOne("OnlineAuction.API.Models.Cathegory", "Cathegory")
                        .WithMany("LotCathegories")
                        .HasForeignKey("CathegoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlineAuction.API.Models.Lot", "Lot")
                        .WithMany("LotCathegories")
                        .HasForeignKey("LotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
