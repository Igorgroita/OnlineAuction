...
namespace OnlineAuction.API.Migrations
{
    ...
    [Migration("20210612103428_thirdMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineAuction.Domain.Auth.Role", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("OnlineAuction.Domain.Auth.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<long>", b =>
                {
                    b.HasOne("OnlineAuction.Domain.Auth.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("OnlineAuction.Domain.Auth.User", null)
                        .WithMany()
